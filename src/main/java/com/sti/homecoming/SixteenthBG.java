...
public class SixteenthBG extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sixteenth_b_g);

        soundEffect = new SoundEffect(this);
        btn_setting = findViewById(R.id.sixteenth_bg_imagebtn);
        btn_okay = findViewById(R.id.btn_okay_sixteenthbg);
        btn_back = findViewById(R.id.btn_back_sixteenthbg);
        videoView = findViewById(R.id.sixteenth_video);

        btn_okay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                soundEffect.NormalSound();
                Intent in = new Intent(getApplicationContext(), problem12.class);
