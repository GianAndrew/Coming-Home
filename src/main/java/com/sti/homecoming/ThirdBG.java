...
public class ThirdBG extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_third_b_g);

        soundEffect = new SoundEffect(this);

        //Declaration
        btn_nxt = findViewById(R.id.btn_nxt_thirdbg);
        btn_settings = findViewById(R.id.btn_menu);
        btn_back = findViewById(R.id.btn_back_thirdbg);
        videoView = findViewById(R.id.third_bg_video);
        ...
        btn_nxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent in = new Intent(ThirdBG.this, problem4.class);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                soundEffect.NormalSound();
                Intent in = new Intent(ThirdBG.this,SecondBG4.class);
                startActivityForResult(in,0);
                overridePendingTransition(0,0);
                finish();
            }
