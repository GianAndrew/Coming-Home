...
public class FifteenthBG extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fifteenth_b_g);

        soundEffect = new SoundEffect(this);
        btn_setting = findViewById(R.id.fifteenth_bg_imagebtn);
        btn_okay = findViewById(R.id.btn_okay_fifteenthbg);
        btn_back = findViewById(R.id.btn_back_fifteenthbg);
        videoView = findViewById(R.id.fifteenthbg_video);
        ...
        String path = "android.resource://"+getPackageName()+"/"+R.raw.fifteenth;
