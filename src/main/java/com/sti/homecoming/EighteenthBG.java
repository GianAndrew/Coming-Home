...
public class EighteenthBG extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eighteenth_b_g);

        soundEffect = new SoundEffect(this);
        btn_setting = findViewById(R.id.eighteen_bg_imagebtn);
        btn_okay = findViewById(R.id.btn_okay_eighteenbg);
        btn_back = findViewById(R.id.btn_back_eighteenbg);
        btn_next = findViewById(R.id.btn_next_eighteenbg);
        videoView = findViewById(R.id.eighteenbg_video);
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                convo_mayari.setText("What are we waiting for? Let’s board the ship and head to our next destination!");
