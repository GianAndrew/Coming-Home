...
public class problem11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        one = findViewById(R.id.p11b1);
        two = findViewById(R.id.p11b2);
        three = findViewById(R.id.p11b3);
        four = findViewById(R.id.p11b4);
        five = findViewById(R.id.p11b5);
        six = findViewById(R.id.p11b6);
        seven = findViewById(R.id.p11b7);
        eight = findViewById(R.id.p11b8);
        nine = findViewById(R.id.p11b9);
        zero = findViewById(R.id.p11b0);

        next = findViewById(R.id.p11confirm);
        soundEffect = new SoundEffect(this);
        ans = findViewById(R.id.p11answer);
    ...
    private void checking() {
        int correct = 100, ans2;
        ans2 = Integer.parseInt(ans.getText().toString());

        Intent i = new Intent(problem11.this, TriviaSeven.class);
        ...
        if (ans2 == correct) {
            ...
            ans.setText("");
            Toast.makeText(problem11.this, "Wrong Answer, Please try again.", Toast.LENGTH_SHORT).show();
        }
    }
}